...
public class ThemeDetailAdapter extends BaseQuickAdapter<String, BaseViewHolder> {
    public ThemeDetailAdapter(@Nullable List<String> data) {
        super(R.layout.fragment_themedetail_item, data);
    }
