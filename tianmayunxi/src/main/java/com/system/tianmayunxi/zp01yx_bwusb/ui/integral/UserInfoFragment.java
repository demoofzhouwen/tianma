    ...
    public void onClick(View view){
        ...
        switch (view.getId()){
            case R2.id.re_nickname:
                 inflate = LayoutInflater.from(getThisContext()).inflate(R.layout.custom_nickname, null, false);
                ...
                break;
            case R2.id.re_info:
                 inflate = LayoutInflater.from(getThisContext()).inflate(R.layout.custom_info, null, false);
                DialogsTools.getInstance().CreateCustomViewDialog(inflate, new DialogsTools.onButtonClickListener() {
                    @Override
                    public void onClick(String message) {
