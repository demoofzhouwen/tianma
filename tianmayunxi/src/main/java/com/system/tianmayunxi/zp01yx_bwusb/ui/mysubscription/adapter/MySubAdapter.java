...
public class MySubAdapter extends BaseQuickAdapter<String, BaseViewHolder> {
    public MySubAdapter(@Nullable List<String> data) {
        super(R.layout.fragment_mysub_item, data);
    }
