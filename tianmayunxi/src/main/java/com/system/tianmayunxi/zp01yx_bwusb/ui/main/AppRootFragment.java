...
public class AppRootFragment extends MVPBaseFragment {
    ...
    protected void initDatas() {
        SupportFragment fragment01 = (SupportFragment) ARouter.getInstance().build(TmyxRouterConfig.TMYX_GFTJ)
                .navigation();
        SupportFragment fragment02 = (SupportFragment) ARouter.getInstance().build(TmyxRouterConfig.TMYX_WDDY)
                .navigation();
        SupportFragment fragment03 = (SupportFragment) ARouter.getInstance().build(TmyxRouterConfig.TMYX_QBZT)
                .navigation();
        SupportFragment fragment04 = (SupportFragment) ARouter.getInstance().build(TmyxRouterConfig.TMYX_WDFB)
                .navigation();
