...
public class PlAllAdapter extends BaseQuickAdapter<String, BaseViewHolder> {
    public PlAllAdapter(@Nullable List<String> data) {
        super(R.layout.fragment_plall_item, data);
    }
