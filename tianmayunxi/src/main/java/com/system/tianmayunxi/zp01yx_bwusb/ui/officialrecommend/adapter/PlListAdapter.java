...
public class PlListAdapter extends BaseQuickAdapter<String, BaseViewHolder> {
    public PlListAdapter(@Nullable List<String> data) {
        super(R.layout.fragment_pllist_item, data);
    }
